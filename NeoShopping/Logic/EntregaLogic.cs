...
namespace NeoShopping.Logic
{
    public class EntregaLogic
    {
        ...
        private static Entrega ObtenerEntregaPorId(NeoShoppingDataContext context, int id)
        {
        ...
        private static void EliminarEntregaDeBaseDeDatos(NeoShoppingDataContext context, Entrega entrega)
        {
        ...
        private static void MostrarListaEntregas(NeoShoppingDataContext context)
        {
            Console.Clear();
            var entregas = context.Entregas.ToList();
        ...
        private static void BuscarEntregaPorId(NeoShoppingDataContext context)
        {
            Console.Clear();
            Console.ForegroundColor = ConsoleColor.Cyan;
