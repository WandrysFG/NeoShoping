...
namespace NeoShopping.Logic
{
    public class DetallesOrdenLogic
    {
        ...
        private static DetalleOrden ObtenerDetalleOrdenPorId(NeoShoppingDataContext context, int id)
        {
        ...
        private static void EliminarDetalleDeBaseDeDatos(NeoShoppingDataContext context, DetalleOrden detalle)
        {
        ...
        private static void MostrarListaDetallesOrden(NeoShoppingDataContext context)
        {
            Console.Clear();
            var detalles = context.DetallesOrden.ToList();
        ...
        private static void BuscarDetalleOrdenPorId(NeoShoppingDataContext context)
        {
            Console.Clear();
            Console.ForegroundColor = ConsoleColor.Cyan;
